function [t,expN,expB,NLog,infor]=Experimental_data(n_experiments)
...
t_s{j}=[0 1 2 5 10];
infor{j}='4rd:50ppm,9log';
data_B{j}(1)=50;

j=5;
%5th:60ppm,6log
data_N{j}=([9.00e5 0 0 0 0])/df;
data_B{j}=[52.78 40.28 40.36 40.15 40.1];
t_s{j}=[0 1 2 5 10];
infor{j}='Validation: 5th:60ppm,6log';
data_B{j}(1)=60;
